...
public struct WaveData
{
    ...
    public int _generateTimingCount;     //シーン内にいるエネミーが何体死んだら再度出現させるか
...
public class GenerateManager : MonoBehaviour
{
    ...
    void UpdateEnemyCount()
    {
        ...
        Debug.Log(_currentWaveCount + "c : wabe" + _waveDate.Count);
        ...
        //死ぬごとに、敵キャラを生成
        if (_deathCount % waveData._generateTimingCount == 0)
        {
            SetEnemy(waveData._generateCount,waveData._generateTypeList);
        }


        //SetEnemy(_waveDate[_currentWaveCount].);
